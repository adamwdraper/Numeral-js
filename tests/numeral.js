    ...
    describe('Format', function() {
        it('should format to a number', function() {
            var tests = [
                    ...
                    [150,'0.0 ak','0.2 k'],
                    // numbers whose toString() is exponential format
                    [0.00000053,'0','0'],
                    [-0.00000053,'0','0'],
                    [0.00000063,'0.0','0.0'],
                    [-0.00000063,'0.0','0.0'],
                    [-82345670000000000000000000,'0','-82345670000000000000000000'],
                    [82345670000000000000000000,'0','82345670000000000000000000'],
                    [-92345670000000000000000000,'0.0','-92345670000000000000000000.0'],
                    [92345670000000000000000000,'0.0','92345670000000000000000000.0'],
                    [92345670000000000000000000,'0000000000000000000000000000,0.000','0,092,345,670,000,000,000,000,000,000.000']
                ],
                i,
                n,
                output;
