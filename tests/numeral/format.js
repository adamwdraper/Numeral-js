...
exports.format = {
    ...
    bits: function(test) {
        var tests = [
                [100,'0bit','100bits'],
                [1000*2,'0 bit','2 Kbits'],
                [1000*1000*5,'0bit','5Mbits'],
                [1000*1000*1000*7.343,'0.[0] bit','7.3 Gbits'],
                [1000*1000*1000*1000*3.1536544,'0.000bit','3.154Tbits'],
                [1000*1000*1000*1000*1000*2.953454534534,'0bit','3Pbits']
            ],
            i;
