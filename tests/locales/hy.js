...
describe('Locale: hy-AM', function() {

    before(function() {
        numeral.locale('hy-AM');
    });
    ...
    describe('Currency', function() {
        it('should format a currency', function() {
            var tests = [
                [1000.234,'0,0.00$','1 000,23 դրամ'],
                [-1000.234,'(0,0$)','(1 000 դրամ)'],
                [-1000.234,'0.00$','-1000,23 դրամ'],
                [1230974,'(0.00a$)','1,23 միլլ․ դրամ']
            ];
    ...
    describe('Unformat', function() {
        it('should unformat', function() {
            var tests = [
                ...
                ['(0,12345)',-0.12345],
                ['(1,23 միլլ․ դրամ)',-1230000],
                ['1,23 միլլ․ դրամ',1230000],
                ['10 հազ․',10000],
                ['-10 հազ․',-10000],
                ['23.',23],
                ['10 000,00 դրամ',10000],
                ['-76%',-0.76],
                ['2:23:57',8637]
            ];
