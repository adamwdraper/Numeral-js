var numeral = require('../../numeral'),
    language = require('../../languages/ru-ua');

numeral.language('ru-ua', language);

exports['language:ru-ua'] = {
    ...
    bytes: function (test) {
        var tests = [
                ...
                [1024*2,'0 b','2 кБ'],
                [1024*1024*5,'0b','5МБ'],
                [1024*1024*1024*7.343,'0.[0] b','7,3 ГБ'],
                [1024*1024*1024*1024*3.1536544,'0.000b','3,154ТБ'],
                [1024*1024*1024*1024*1024*2.953454534534,'0b','3ПБ']
            ],
            i;
